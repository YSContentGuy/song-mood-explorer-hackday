...
const mockUserProfiles = [
  {
    ...
    skillLevel: 2,
    instrument: "guitar",
    genrePreferences: ["folk", "acoustic", "spiritual"],
    genreAvoidance: ["metal", "hard_rock", "hip-hop"],
  ...
  },
  {
    ...
    skillLevel: 5,
    instrument: "guitar",
    genrePreferences: ["funk", "dance", "pop"],
    genreAvoidance: ["classical", "jazz"],
  ...
  },
  {
    ...
    skillLevel: 8,
    instrument: "guitar",
    genrePreferences: ["progressive", "classical", "jazz"],
    genreAvoidance: ["pop", "dance"],
